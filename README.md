...
2. Configure firewall rules to allow your client IP
3. Connect to the database using SSMS or Azure tools
4. Run the scripts in the `sql/` folder:
...
Run `Main.java` and use the menu to interact with the system.
